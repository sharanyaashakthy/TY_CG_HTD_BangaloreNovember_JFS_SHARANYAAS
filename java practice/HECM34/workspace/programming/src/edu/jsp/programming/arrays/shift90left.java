...
Scanner sc=new Scanner(System.in);
		...
		System.out.println("Matrix array after Row reverse");
		System.out.println("------------------------------");
		for(int i =0;i<row;i++)
		{
			for(int j=0;j<col;j++)
		...
		System.out.println("Matrix array after 90 degree left shift");
		System.out.println("---------------------------------------");
		for(int i=0;i<col;i++)
		{
			for(int j=0;j<row;j++)
